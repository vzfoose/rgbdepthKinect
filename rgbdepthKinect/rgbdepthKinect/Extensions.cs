...
namespace rbgdepthKinect
{
    ...
    {
        #region Camera
        public static byte[] rawColor(this ColorFrame frame)
        {
        ...
        public static ushort[] rawDepth(this DepthFrame frame)
        {
            int width = frame.FrameDescription.Width;
            int height = frame.FrameDescription.Height;
        ...
        public static ushort[] rawIR(this InfraredFrame frame)
        {
            int width = frame.FrameDescription.Width;
            int height = frame.FrameDescription.Height;
            PixelFormat format = PixelFormats.Bgr32;
        ...
        public static ImageSource ToBitmap(this DepthFrame frame)
        {
            ...
            //create grayscale representation of depth for display purposes
            int colorIndex = 0;
